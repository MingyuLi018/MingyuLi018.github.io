...
- [photoswipe-setup.js](_scripts/photoswipe-setup.js)
</cite>
...
- 增强图片画廊系统，支持更多媒体类型
- **重大更新**：竞赛画廊系统全面重组，从上海图形杯2025到上海机械创新2025的图片迁移，gallery ID更新，布局结构简化，以及内容组织的重大调整
...
Scripts[_scripts/<br/>JavaScript文件]
...
#### 重大重组变更
- **上海图形杯2025** → **上海机械创新2025**：竞赛名称从"上海图形杯"正式更改为"上海机械创新"
- **gallery ID更新**：所有图片画廊ID从`shgc-*`更新为`shmech-*`，确保唯一性和语义化
- **布局结构简化**：移除了复杂的嵌套结构，采用更直接的层级组织
- **内容组织调整**：重新整理了各竞赛项目的展示顺序和分类
...
**gallery ID更新问题**
- 确认所有gallery ID从`shgc-*`更新为`shmech-*`
- 检查图片路径是否对应新的文件夹结构
- 验证Photoswipe初始化是否正确绑定新ID
