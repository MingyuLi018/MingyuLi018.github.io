...
contributions_en:
  - "Served as a core team member, responsible for mechanical design and modeling, as well as manufacturing-process planning for selected parts"
...
contributions_zh:
  - "作为主要成员，负责机械结构设计与建模，并参与部分零件的加工方案设计"
